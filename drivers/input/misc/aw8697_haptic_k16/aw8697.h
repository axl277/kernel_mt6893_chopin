...
enum aw8697_haptic_cali_lra {
	AW8697_WRITE_ZERO = 0,
	AW8697_F0_CALI_LRA = 1,
	AW8697_OSC_CALI_LRA = 2,
};
/*********************************************************
 *
 * struct
...
struct aw8697 {
	...
	struct aw8697_trig trig[AW8697_TRIG_NUM];
 ...
 *
 ********************************************************/
extern int aw8697_parse_dt(struct device *dev, struct aw8697 *aw8697,
			   struct device_node *np);
extern int aw8697_haptics_upload_effect(struct input_dev *dev,
					struct ff_effect *effect,
					struct ff_effect *old);
extern int aw8697_haptics_playback(struct input_dev *dev, int effect_id,
				   int val);
extern int aw8697_haptics_erase(struct input_dev *dev, int effect_id);
extern void aw8697_haptics_set_gain(struct input_dev *dev, u16 gain);
extern void aw8697_haptics_set_gain_work_routine(struct work_struct *work);
extern void aw8697_interrupt_setup(struct aw8697 *aw8697);
extern int aw8697_vibrator_init(struct aw8697 *aw8697);
extern int aw8697_haptic_init(struct aw8697 *aw8697);
extern int aw8697_ram_init(struct aw8697 *aw8697);
extern irqreturn_t aw8697_irq(int irq, void *data);
extern struct attribute_group aw8697_vibrator_attribute_group;
extern struct miscdevice aw8697_haptic_misc;
/*********************************************************
 *
 * ioctl
 *
